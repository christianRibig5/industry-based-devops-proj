...
aws ecr-public get-login-password --profile dev-admin --region us-east-1 | helm registry login \
...
echo
echo "✅ All charts downloaded and extracted successfully into ./retailstore-charts directory"
echo "--------------------------------------------"
tree -L 2 || ls -1